<nav class="bg-orange-600 shadow-lg" x-data="{ open: false }">
      ...
      <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <div class="hidden sm:block sm:ml-6">
          <div class="flex space-x-4">
            ...
            <a href="{{ route('welcome') }}" class="lg:text-lg text-gray-100 hover:bg-orange-700 hover:text-white px-3 py-2 rounded-md font-semibold text-lg">Home</a>
            <a href="{{ route('products.index') }}" class="lg:text-lg text-gray-100 hover:bg-orange-700 hover:text-white px-3 py-2 rounded-md font-semibold text-lg">Products</a>
            <a href="#" class="lg:text-lg text-gray-100 hover:bg-orange-700 hover:text-white px-3 py-2 rounded-md font-semibold text-lg">About Us</a>
            <a href="#" class="lg:text-lg text-gray-100 hover:bg-orange-700 hover:text-white px-3 py-2 rounded-md font-semibold text-lg">Contact Us</a>
  ...
  <div class="sm:hidden" id="mobile-menu" x-show="open" x-on:click.away="open = false">
    <div class="px-2 pt-2 pb-2 space-y-1">
      ...
      <a href="{{ route('welcome') }}" class="lg:text-md text-gray-100 hover:bg-orange-700 hover:text-white px-3 py-2 rounded-md text-md font-semibold">Home</a>
      <a href="{{ route('products.index') }}" class="lg:text-md text-gray-100 hover:bg-orange-700 hover:text-white px-3 py-2 rounded-md text-md font-semibold">Products</a>
      <a href="#" class="lg:text-md text-gray-100 hover:bg-orange-700 hover:text-white px-3 py-2 rounded-md text-md font-semibold">About Us</a>
      <a href="#" class="lg:text-md text-gray-100 hover:bg-orange-700 hover:text-white px-3 py-2 rounded-md text-md font-semibold">Contact Us</a>
